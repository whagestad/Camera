...
public class MainActivity extends AppCompatActivity {
    ...
    private void takeThumbnailPicture() {
        // Implicit Intent to open an app which can take a picture, probably a built-in camera app
        ...
        if (pictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            Toast.makeText(this, "Your device does not have a camera pp", Toast.LENGTH_LONG).show();
        }
    }
